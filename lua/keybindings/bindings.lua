...
vim.keymap.set('n', '<Leader>e', "<cmd>Lspsaga show_line_diagnostics", opts)
...
function keybindings.attached_binds(bufnr)
    ...
    vim.keymap.set('i', '<C-s>', "<cmd>Lspsaga signature_help<CR>", bufopts)
    -- vim.keymap.set('n', 'gy', vim.lsp.buf.type_definition, bufopts)
    vim.keymap.set('n', 'gy', '<cmd>Lspsaga goto_typedefinition<CR>', bufopts)
    -- vim.keymap.set('n', '<Leader>rn', vim.lsp.buf.rename, bufopts)
    vim.keymap.set('n', '<Leader>rn', '<cmd>Lspsaga rename', bufopts)
